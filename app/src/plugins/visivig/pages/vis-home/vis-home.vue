			...
			<div class="container carousel-wrapper">
				<div class="row category-cards">
					<div class="col-md-4  mb-3">
						<wc-home-category-card title="Bývanie" img="Home.svg" link="./osobne-financie-byvanie"/>
					</div>
					<div class="col-md-4 mb-3">
						<wc-home-category-card title="Rodina a deti" img="Family-group.svg" link="./osobne-financie-rodina-a-deti"/>
					</div>
					<div class="col-md-4 mb-3">
						<wc-home-category-card title="Auto" img="Car.svg" link="./osobne-financie-auto"/>
					</div>
					<div class="col-md-4">
						<wc-home-category-card title="Dôchodok" img="OldFamily-group.svg" link="./osobne-financie-dochodok"/>
					</div>
					<div class="col-md-4">
						<wc-home-category-card title="Exekúcia" img="Execution.svg" link="./osobne-financie-exekucia"/>
					</div>
					<div class="col-md-4">
						<wc-home-category-card title="Práca a dane" img="Work.svg" link="./osobne-financie-praca-dane"/>
					</div>
				</div>
			</div>
		</div>
...
export default {
	components: {
		...
		'wc-home-carousel': () => import('@/plugins/wordpress/web-components/wc-homeCarousel/wc-homeCarousel.vue'),
		'wc-home-category-card': () => import('@/plugins/wordpress/web-components/wc-homeCategoryCard/wc-homeCategoryCard.vue'),
		'wc-advanced-img-home-cards': () => import('@/plugins/wordpress/web-components/wc-advancedImgHomeCards/wc-advancedImgHomeCards.vue')
	}
}
</script>
