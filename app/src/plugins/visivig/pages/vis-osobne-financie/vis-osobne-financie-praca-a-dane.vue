	...
	<div>
        ...
        <div id="zakladneInformacie">
            ...
            <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
                <div class="row">
                    <div class="col-md-3">
                        <wc-mini-card title="Dane" desc="Za akých podmienok musím zdaniť príjem z predaja bytu?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Samostatná zárobková činnosť" desc="Aké sú lehoty na podanie daňového priznania pre SZČO?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-samostatna-zarobkova-cinnost-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Ako si zvýšiť príjem?" desc="Ako si privyrábať?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-zvysenie-prijmu-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Pracujem" desc="Začínam pracovať po škole. Na čo myslieť?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-pracujem-clanok"/>
                    </div>
                </div>
            </div>
