	...
	<div>
        ...
        <div id="zakladneInformacie">
            ...
            <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
                <div class="row">
                    <div class="col-md-3">
                        <wc-mini-card title="Hypotekárny úver - nadobudnutie bývania" desc="Zabezpečenie hypotéky (zábezpeka, ručiteľ)" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-nadobudnutie-byvania-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Americká hypotéka" desc="Čo je americká hypotéka ako funguje" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-americka-hypoteka-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Žiadosť o úver" desc="Ako dostať najlacnejšiu hypotéku?" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-ziadost-o-uver-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Splácanie úveru" desc="Refinancovanie (ako prebieha, kedy refinancovať)" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-splacanie-uveru-clanok"/>
                    </div>
                </div>
            </div>
