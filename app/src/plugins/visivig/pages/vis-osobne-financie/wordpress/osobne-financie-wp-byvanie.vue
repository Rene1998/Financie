                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Kúpa alebo prenájom" desc="Je lepšie kúpiť alebo prenajať?" img="Blue-home.svg" link="/osobne-financie-byvanie-kupa-alebo-prenajom-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Financovanie kúpy" desc="Ako dofinancovať úver?" img="Blue-home.svg" link="/osobne-financie-byvanie-financovanie-kupy-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Poistenie" desc="Ako zabezpečiť dom?" img="Blue-home.svg" link="/osobne-financie-byvanie-poistenie-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Technológie čo vedia ušetriť" desc="Presvedčte sa ako môžete ušetri’t využívaním moderných technológii" img="Blue-home.svg" link="/osobne-financie-byvanie-technologie-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
