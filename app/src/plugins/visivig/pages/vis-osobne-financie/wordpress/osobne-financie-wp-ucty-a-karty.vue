                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Bežný Účet" desc="Ako mať bankový účet zadarmo" img="Blue-home.svg" link="/osobne-financie-ucty-a-karty-bezny-ucet-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Sporiaci Účet" desc="Ako sa odlišuje sporiaci účet od bežného účtu" img="Blue-home.svg" link="/osobne-financie-ucty-a-karty-sporiaci-ucet-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                   <wc-mini-card title="Kreditná Karta" desc="Čo je kreditná karta?" img="Blue-home.svg" link="/osobne-financie-ucty-a-karty-kreditna-karta-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Debetná Karta" desc="Čo je debetná karta?" img="Blue-home.svg" link="/osobne-financie-ucty-a-karty-debetna-karta-clano"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
