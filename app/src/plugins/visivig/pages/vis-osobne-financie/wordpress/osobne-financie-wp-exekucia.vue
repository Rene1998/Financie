                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Exekúcia" desc="Na čo sa vzťahuje exekúcia? Na čo sa nevzťahuje exekúcia?" img="Blue-home.svg" link="/osobne-financie-exekucia-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Pred Exekúciou" desc="Čo robiť ak mi hrozí exekúcia? Je možné dostať úver, keď som v exekúcií?" img="Blue-home.svg" link="/osobne-financie-exekucia-pred-exekuciou-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Počas exekúcie" desc="Aké druhy oddlženia existujú? Aký druh mám vybrať ak nechcem prísť o majetok?" img="Blue-home.svg" link="/osobne-financie-exekucia-pocas-exekucie-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <wc-mini-card title="Právo a financie" desc="Orientujte sa vo finančno-právnom svete" img="Blue-home.svg" link="/osobne-financie-exekucia-pravo-a-financie-clanok"></wc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
