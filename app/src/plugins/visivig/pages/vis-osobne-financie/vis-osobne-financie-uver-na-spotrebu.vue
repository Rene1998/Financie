<template>
	<div>
        ...
        <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
                <div class="row">
                    <div class="col-md-3">
                        <wc-mini-card title="Spotrebný úver" desc="Ako funguje spotrebný úver" img="Blue-home.svg" link="/osobne-financie-uver-na-spotrebu-spotrebny-uver-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Krátkodobé úvery" desc="Nástrahy, úrokové sadzby" img="Blue-home.svg" link="/osobne-financie-uver-na-spotrebu-kratkodobe-uvery-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Čerpanie a splácanie" desc="Ako dlho trvá čerpanie úverov" img="Blue-home.svg" link="/osobne-financie-uver-na-spotrebu-cerpanie-a-splacanie-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Nebankové úvery a pôžičky" desc="Aký je rozdiel medzi bankovou anebankovou pôžičkou" img="Blue-home.svg" link="/osobne-financie-uver-na-spotrebu-nebankove-uvery-a-pozicky-clanok"/>
                    </div>
                </div>
            </div>
