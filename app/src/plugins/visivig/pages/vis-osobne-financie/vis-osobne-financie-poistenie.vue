	...
	<div>
        ...
        <div id="zakladneInformacie">
            ...
            <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
                <div class="row">
                    <div class="col-md-3">
                        <wc-mini-card title="Životné poistenie" desc="Hlavné parametre životného postenia" img="Blue-home.svg" link="/osobne-financie-poistenie-zivotne-poistenie-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Poistenie auta (neživotné poistenie)" desc="Prečo si uzavrieť havarijné poistenie keď mám PZP?" img="Blue-home.svg" link="/osobne-financie-poistenie-auta-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Poistenie nehnuteľnosti/domácnosti" desc="Na čo si dávať pozor pri uzatváraní poistenia na dom?" img="Blue-home.svg" link="/osobne-financie-poistenie-nehnutelnosti-clanok"/>
                    </div>
                    <div class="col-md-3">
                        <wc-mini-card title="Cestovné poistenie" desc="Kedy a prečo sa oplatí?" img="Blue-home.svg" link="/osobne-financie-poistenie-cestovne-poistenie-clanok"/>
                    </div>
                </div>
            </div>
