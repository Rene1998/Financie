			...
			<div class="switch-wrapper mb-5">
				<div class="row switch d-flex justify-content-center align-items-center text-center">
					<a 
						...
						href="./pre-skoly-zakladna-skola-2-stupen-8-9-rocnik-ucebne-materialy">Učebné materiály
					</a>
				
					<a 
						class="switch-button p-0 switchIsActive col-6 d-flex justify-content-center align-items-center text-center"
						href="./pre-skoly-zakladna-skola-2-stupen-8-9-rocnik-videa">Videá
					</a>
				</div>
			</div>
		</div>
		<div class="container">
			<wc-advanced-img-cards page="zakladna-skola-2.stupen" year="8-rocnik" category="advancedImgCardVideo"/>
		</div>
...
export default {
	components: {
		...
		'wc-pre-skoly-advanced-carousel' : () => import('@/plugins/wordpress/web-components/wc-preSkolyAdvancedCarousel/wc-preSkolyAdvancedCarousel.vue')
	}
}
</script>