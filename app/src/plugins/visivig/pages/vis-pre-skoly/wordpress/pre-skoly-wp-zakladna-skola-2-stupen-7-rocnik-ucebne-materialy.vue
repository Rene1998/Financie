    ...
    <div>
        ...
        <div class="container">
            <div class="switch-wrapper mb-5">
                ...
                <a class=" switch-button p-0 switchIsActive col-6 d-flex justify-content-center align-items-center text-center" href="./pre-skoly-zakladna-skola-2-stupen-7-rocnik-ucebne-materialy">
                    Učebné materiály
                </a>
                <a class="switch-button p-0 col-6 d-flex justify-content-center align-items-center text-center" href="./pre-skoly-zakladna-skola-2-stupen-7-rocnik-videa">
                    Videá
                </a>
                </div>
            </div>
        ...
        <!-- wp:wp-bootstrap-blocks/container -->
            ...
            <!-- wp:html -->
                <wc-advanced-img-cards page="zakladna-skola-2.stupen" year="7-rocnik" category="advancedImgCardLink"></wc-advanced-img-cards>
            <!-- /wp:html -->
        <!-- /wp:wp-bootstrap-blocks/container -->
