    ...
    <div>
                ...
                <div class="wp-block-columns">
                    ...
                    <!-- wp:column {"width":"20%"} -->
                        <div class="wp-block-column" style="flex-basis: 20%">
                            ...
                            <!-- wp:html -->
                                <wc-category-card title="8. Ročník" img="rocnik8.svg" link="./pre-skoly-zakladna-skola-2-stupen-8-rocnik-ucebne-materialy" isactive="true"></wc-category-card>
                            <!-- /wp:html -->
                        </div>
                    <!-- /wp:column -->
        ...
        <div class="container">
            <div class="switch-wrapper mb-5">
                ...
                <a class=" switch-button p-0 col-6 d-flex justify-content-center align-items-center text-center" href="./pre-skoly-zakladna-skola-2-stupen-8-rocnik-ucebne-materialy">
                    Učebné materiály
                </a>
                <a class="switch-button p-0 switchIsActive col-6 d-flex justify-content-center align-items-center text-center" href="./pre-skoly-zakladna-skola-2-stupen-8-rocnik-videa">
                    Videá
                </a>
                </div>
            </div>
        ...
        <!-- wp:wp-bootstrap-blocks/container -->
            ...
            <!-- wp:html -->
                <wc-advanced-img-cards page="zakladna-skola-2.stupen" year="8-rocnik" category="advancedImgCardVideo"></wc-advanced-img-cards>
            <!-- /wp:html -->
        <!-- /wp:wp-bootstrap-blocks/container -->
    </div>
</template>