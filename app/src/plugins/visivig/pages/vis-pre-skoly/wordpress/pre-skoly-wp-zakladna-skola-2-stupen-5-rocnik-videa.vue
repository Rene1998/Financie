    ...
    <div>
                ...
                <div class="wp-block-columns">
                    <!-- wp:column {"width":"20%"} -->
                        <div class="wp-block-column" style="flex-basis: 20%">
                            ...
                            <!-- wp:html -->
                                <wc-category-card title="5. Ročník" img="rocnik5.svg" link="./pre-skoly-zakladna-skola-2-stupen-5-rocnik-ucebne-materialy" isactive="true"></wc-category-card>
                            <!-- /wp:html -->
                        </div>
                    <!-- /wp:column -->
                    ...
                    <!-- wp:column {"width":"20%"} -->
                        <div class="wp-block-column" style="flex-basis: 20%">
                            ...
                            <!-- wp:html -->
                                <wc-category-card title="6. Ročník" img="rocnik6.svg" link="./pre-skoly-zakladna-skola-2-stupen-6-rocnik-ucebne-materialy"></wc-category-card>
                            <!-- /wp:html -->
                        </div>
                    <!-- /wp:column -->
        ...
        <div class="container">
            <div class="switch-wrapper mb-5">
                ...
                <a class=" switch-button p-0 col-6 d-flex justify-content-center align-items-center text-center" href="./pre-skoly-zakladna-skola-2-stupen-5-rocnik-ucebne-materialy">
                    Učebné materiály
                </a>
                <a class="switch-button p-0 switchIsActive col-6 d-flex justify-content-center align-items-center text-center" href="./pre-skoly-zakladna-skola-2-stupen-5-rocnik-videa">
                    Videá
                </a>
                </div>
            </div>
        ...
        <!-- wp:wp-bootstrap-blocks/container -->
            ...
            <!-- wp:html -->
                <wc-advanced-img-cards page="zakladna-skola-2.stupen" year="5-rocnik" category="advancedImgCardVideo"></wc-advanced-img-cards>
            <!-- /wp:html -->
        <!-- /wp:wp-bootstrap-blocks/container -->
    </div>
</template>