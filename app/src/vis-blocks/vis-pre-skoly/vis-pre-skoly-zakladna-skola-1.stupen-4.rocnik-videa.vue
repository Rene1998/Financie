	...
	<div>
        ...
        <div class="d-block d-sm-block d-md-none">
			<div class="carousel-wrapper">
				<vc-pre-skoly-prvy-stupen-carousel/>
			</div>
		</div>
		...
		<div class="switch-wrapper mb-5">
			<div class="btn-group">
				<button class="switch-button p-0">
					<a href="./pre-skoly-zakladna-skola-1-stupen-4-rocnik-ucebne-materialy">Učebné materiály</a>
				</button>
				<button class="switch-button p-0 switchIsActive">
					<a href="./pre-skoly-zakladna-skola-1-stupen-4-rocnik-videa">Videá</a>
				</button>
			</div>
		</div>
		<div class="container">
