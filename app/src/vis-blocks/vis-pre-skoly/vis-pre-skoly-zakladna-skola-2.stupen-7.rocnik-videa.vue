		...
		<div class="switch-wrapper mb-5">
			<div class="btn-group">
				<button class="switch-button p-0">
					<a href="./pre-skoly-zakladna-skola-2-stupen-7-rocnik-ucebne-materialy">Učebné materiály</a>
				</button>
				<button class="switch-button p-0 switchIsActive">
					<a href="./pre-skoly-zakladna-skola-2-stupen-7-rocnik-videa">Videá</a>
				</button>
			</div>
		</div>
		<div class="container">
			<vc-advanced-img-cards page="zakladna-skola-2.stupen" year="7-rocnik" category="advancedImgCardVideo"/>
		</div>
