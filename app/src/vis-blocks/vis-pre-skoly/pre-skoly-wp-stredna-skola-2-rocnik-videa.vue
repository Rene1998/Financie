<template>
    <div>
                ...
                <div class="wp-block-columns">
                    ...
                    <!-- wp:column {"width":"25%"} -->
                        <div class="wp-block-column" style="flex-basis: 25%">
                            ...
                            <!-- wp:html -->
                                <vc-category-card title="2. Ročník" img="rocnik2.svg" link="./pre-skoly-stredna-skola-2-rocnik-ucebne-materialy" isactive="true"></vc-category-card>
                            <!-- /wp:html -->
                        </div>
                    <!-- /wp:column -->
                    ...
                    <!-- wp:column {"width":"25%"} -->
                        <div class="wp-block-column" style="flex-basis: 25%">
                            ...
                            <!-- wp:html -->
                                <vc-category-card title="3. Ročník" img="rocnik3.svg" link="./pre-skoly-stredna-skola-3-rocnik-ucebne-materialy"></vc-category-card>
                            <!-- /wp:html -->
                        </div>
                    <!-- /wp:column -->
        ...
        <!-- wp:wp-bootstrap-blocks/container -->
            ...
            <!-- wp:html -->
                <vc-advanced-img-cards page="stredna-skola" year="2-rocnik" category="advancedImgCardVideo"></vc-advanced-img-cards>
            <!-- /wp:html -->
        <!-- /wp:wp-bootstrap-blocks/container -->
    </div>
</template>