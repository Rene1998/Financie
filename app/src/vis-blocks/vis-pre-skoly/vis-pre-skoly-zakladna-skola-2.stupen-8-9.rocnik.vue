<template>
	<div>
		...
		<div class="container carousel-wrapper">
			<div class="row">
				<div class="col-3">
					<vc-category-card title="5. Ročník" img="rocnik1.svg" link="./pre-skoly-zakladna-skola-2-stupen-6-rocnik"></vc-category-card>
				</div>
				<div class="col-3">
					<vc-category-card title="6. Ročník" img="rocnik2.svg" link="./pre-skoly-zakladna-skola-2-stupen-7-rocnik"></vc-category-card>
				</div>
				<div class="col-3">
					<vc-category-card title="7. Ročník" img="rocnik3.svg" link="./pre-skoly-zakladna-skola-2-stupen-8-rocnik"></vc-category-card>
				</div>
				<div class="col-3">
		...
		<div class="container">
			<vc-advanced-img-cards page="zakladna-skola-8.stupen" year="8-9-rocnik" category="advancedImgCardLink"/>
		</div>
