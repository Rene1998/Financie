<template>
    <div>
                ...
                <div class="wp-block-columns">
                    ...
                    <!-- wp:column {"width":"20%"} -->
                        <div class="wp-block-column" style="flex-basis: 20%">
                            ...
                            <!-- wp:html -->
                                <vc-category-card title="6. Ročník" img="rocnik2.svg" link="./pre-skoly-zakladna-skola-2-stupen-6-rocnik-ucebne-materialy" isactive="true"></vc-category-card>
                            <!-- /wp:html -->
                        </div>
                    <!-- /wp:column -->
        ...
        <!-- wp:wp-bootstrap-blocks/container -->
            ...
            <!-- wp:html -->
                <vc-advanced-img-cards page="zakladna-skola-2.stupen" year="6-rocnik" category="advancedimgCardVideo"></vc-advanced-img-cards>
            <!-- /wp:html -->
        <!-- /wp:wp-bootstrap-blocks/container -->
    </div>
</template>