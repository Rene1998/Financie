<template>
	<div>
		...
		<div class="container">
			<vc-advanced-img-cards page="zakladna-skola-2.stupen" year="8-rocnik" category="advancedImgCardVideo"/>
		</div>
...
export default {
	components: {
		...
		'vc-pre-skoly-advanced-carousel' : () => import('@/vis-webcomponents/vc-preSkolyAdvancedCarousel/vc-preSkolyAdvancedCarousel.vue')
	}
}
</script>