                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Rozpočet domácnosti" desc="Aké sú základné princípy pre hospodárenie domácnosti?" img="Blue-home.svg" link="/osobne-financie-rodina-a-deti-rozpocet-domacnosti-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Deti" desc="Ako je najvýhodnejšie sporiť deťom?" img="Blue-home.svg" link="/osobne-financie-rodina-a-deti-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                   <vc-mini-card title="Manželstvo" desc="Ako sa finančne pripraviť na svadbu? Na čo myslieť z finančného hľadiska?" img="Blue-home.svg" link="/osobne-financie-rodina-a-deti-manzelstvo-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Ako financovať vzdelanie?" desc="" img="Blue-home.svg" link="/osobne-financie-rodina-a-deti-financovanie-vzdelania-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
