<template>
    <div>
                ...
                <div class="byvanie-welcome-text">
                    <div class="col d-flex flex-column b-arrow mb-5">
                        ...
                        <p class="mt-4 content">
                            Variabilná úroková sadzba, Fixácia, Americká hypotéka
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Hypotekárny úver - nadobudnutie bývania" desc="Zabezpečenie hypotéky (zábezpeka, ručiteľ)" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-nadobudnutie-byvania-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Americká hypotéka" desc="Čo je americká hypotéka ako funguje" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-americka-hypoteka-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                   <vc-mini-card title="Žiadosť o úver" desc="Ako dostať najlacnejšiu hypotéku?" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-ziadost-o-uver-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Splácanie úveru" desc="Refinancovanie (ako prebieha, kedy refinancovať)" img="Blue-home.svg" link="/osobne-financie-hypotekarny-uver-splacanie-uveru-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
        ...
        <div id="najnovsieClanky">
            <div class="container text-center mt-5 mb-5 hardcode-text">
                <h4 style="text-align: center">
                    Najnovšie články o hypotekárnom úvere
                </h4>
                <p style="text-align: center">
                    Pripravili sme pre vás všetky možné finančné otázky a odpovede <br>
                    na ktoré môžete naraziť vo vašom živote.
        ...
        <div id="najnovsieProdukty">
            <div class="container text-center mt-5 mb-5 hardcode-text">
                ...
                <p style="text-align: center">
                    Pripravili sme si pre vás tie najlepšie produkty v rámci hypotekárného úveru
                </p>
            </div>
        </div>
