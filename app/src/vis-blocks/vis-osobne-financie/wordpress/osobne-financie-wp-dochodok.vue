                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="1. pilier" desc="K čomu je? Ako funguje? Ako si z neho vybrať peniaze?" img="Blue-home.svg" link="/osobne-financie-dochodok-1-pilier-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="2. pilier" desc="K čomu je? Ako funguje? Ako si z neho vybrať peniaze?" img="Blue-home.svg" link="/osobne-financie-dochodok-2-pilier-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="3. pilier" desc="K čomu je? Ako funguje? Ako si z neho vybrať peniaze?" img="Blue-home.svg" link="/osobne-financie-dochodok-3-pilier-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Súkromne Sporenie" desc="Nespoliahjte sa na štát avytvorte si vlastný zdroj dôchodku" img="Blue-home.svg" link="/osobne-financie-dochodok-sukromne-sporenie-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
