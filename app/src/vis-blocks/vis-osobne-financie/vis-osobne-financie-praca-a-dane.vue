	...
	<div>
        ...
        <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
            <div class="row">
                ...
                <div class="col-md-3">
                    <vc-mini-card title="Samostatná zárobková činnosť" desc="Aké sú lehoty na podanie daňového priznania pre SZČO?" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Ako si zvýšiť príjem?" desc="Ako si privyrábať?" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Pracujem" desc="Začínam pracovať po škole. Na čo myslieť?" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
            </div>
        </div>
