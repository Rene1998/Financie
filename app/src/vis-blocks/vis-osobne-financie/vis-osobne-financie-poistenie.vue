	...
	<div>
        ...
        <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
            <div class="row">
                ...
                <div class="col-md-3">
                    <vc-mini-card title="Poistenie auta (neživotné poistenie)" desc="Prečo si uzavrieť havarijné poistenie keď mám PZP?" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Poistenie nehnuteľnosti/domácnosti" desc="Na čo si dávať pozor pri uzatváraní poistenia na dom?" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Cestovné poistenie" desc="Kedy a prečo sa oplatí?" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
            </div>
        </div>
