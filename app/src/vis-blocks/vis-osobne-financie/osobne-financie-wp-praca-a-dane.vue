<template>
    <div>
                    ...
                    <div class="wp-block-columns">
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Dane" desc="Za akých podmienok musím zdaniť príjem z predaja bytu?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Samostatná zárobková činnosť" desc="Aké sú lehoty na podanie daňového priznania pre SZČO?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-samostatna-zarobkova-cinnost-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                   <vc-mini-card title="Ako si zvýšiť príjem?" desc="Ako si privyrábať?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-zvysenie-prijmu-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                        ...
                        <!-- wp:column {"width":"25%"} -->
                            <div class="wp-block-column" style="flex-basis: 25%">
                                ...
                                <!-- wp:html -->
                                    <vc-mini-card title="Pracujem" desc="Začínam pracovať po škole. Na čo myslieť?" img="Blue-home.svg" link="/osobne-financie-praca-a-dane-pracujem-clanok"></vc-mini-card>
                                <!-- /wp:html -->
                            </div>
                        <!-- /wp:column -->
                    </div>
        ...
        <div id="najnovsieClanky">
            <div class="container text-center mt-5 mb-5 hardcode-text">
                <h4 style="text-align: center">
                    Najnovšie články o praci a daniach
                </h4>
                <p style="text-align: center">
                    Pripravili sme pre vás všetky možné finančné otázky a odpovede <br>
                    na ktoré môžete naraziť vo vašom živote.
        ...
        <div id="najnovsieProdukty">
            <div class="container text-center mt-5 mb-5 hardcode-text">
                ...
                <p style="text-align: center">
                    Pripravili sme si pre vás tie najlepšie produkty v rámci prace a dani
                </p>
            </div>
        </div>
