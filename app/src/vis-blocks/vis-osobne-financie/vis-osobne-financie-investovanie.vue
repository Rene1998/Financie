<template>
	<div>
        ...
        <div class="container mt-5 mb-5 d-none d-md-block d-lg-block d-xl-block">
            <div class="row">
                <div class="col-md-3">
                    <vc-mini-card title="Spotrebný úver" desc="Ako funguje spotrebný úver" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Krátkodobé úvery" desc="Nástrahy, úrokové sadzby" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Čerpanie a splácanie" desc="Ako dlho trvá čerpanie úverov" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
                <div class="col-md-3">
                    <vc-mini-card title="Nebankové úvery a pôžičky" desc="Aký je rozdiel medzi bankovou anebankovou pôžičkou" img="Blue-home.svg" link="https://financie.hybridlab.dev/pre-skoly/zakladna-skola-1.stupen"/>
                </div>
            </div>
        </div>
        <div class="d-block d-sm-block d-md-none">
			<div class="carousel-wrapper">
				<vc-osobne-financie-carousel 
                    ...
                    card1_link="/osobne-financie-investovanie-spotrebny-uver-clanok"

                    card2_title="Krátkodobé úvery"
                    card2_desc="Nástrahy, úrokové sadzby"
                    card2_img="Blue-home.svg"
                    card2_link="/osobne-financie-investovanie-kratkodobe-uvery-clanok"

                    card3_title="Čerpanie a splácanie"
                    card3_desc="Ako dlho trvá čerpanie úverov"
                    card3_img="Blue-home.svg"
                    card3_link="/osobne-financie-investovanie-cerpanie-a-splacanie-clanok"
                    ...
                    card4_link="/osobne-financie-investovanie-nebankove-uvery-a-pozicky-clanok"/>
			</div>
		</div>
        <div class="container text-center mt-5 mb-5 hardcode-text">
            <h4>
